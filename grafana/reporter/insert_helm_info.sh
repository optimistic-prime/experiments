...
do
  ...
  PGPASSWORD=$PASS psql -U $USER -h $HOST -d $DB -p 5432 -c "INSERT INTO helm_schema.helm_table (name, status, app_version, last_update) VALUES ('$NAME', '$STATUS', '$APP_VERSION', '$LAST_UPDATE');"
done
